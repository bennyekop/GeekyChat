...
import com.geekyindonesia.geekychat.SignInActivity
    ...
    override fun onStart() {
        ...
        FirestoreUtil.getCurrentUser { user ->
            if (this@MyAccountFragment.isVisible) {
                ...
                if (!pictureJustChanged && user.profilPicturePath != null)
                    GlideApp.with(this)
                        .load(StorageUtil.pathToReference(user.profilPicturePath ))
